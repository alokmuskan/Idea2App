// Intent classifier used to route requests into create/refine/debug/explain.
import { completeText, resolveModel } from "./providers.js";

const VALID_INTENTS = new Set(["create", "refine", "debug", "explain"]);

// Pull the most recent user message for classification.
...
// Heuristic signal: if we have prior structure, refinements are more likely.
...
// Fallback heuristic when model-based classification fails.
